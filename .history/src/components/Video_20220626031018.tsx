    ...
    <div className="flex-1">
      ...
      <div className='p-8 max-w-[1100px] mx-auto'>
        ...
        <div className='flex items-start gap-16'>
          <div className='flex-1'>
            <h1 className='text-2xl font-bold'>{data.lesson.videoId}</h1>
            ...
            <div className='flex items-center gap-4 mt-6'>
              <img
                src="https://avatars.githubusercontent.com/u/83144784?v=4"
                alt="perfil professor"
                className='h-16 w-16 rounded-full border-2 border-blue-500'
              />
              <div className='leading-relaxed'>
                <strong className='font-bold text-2xl block'>Alexandre Talles</strong>
                <span className='text-gray-200 text-sm block'>CTO @XT7</span>
              </div>
            </div>
        ...
        <div className='gap-8 grid grid-cols-2 mt-20'>
          ...
          hover:bg-gray-600 transition-colors'>
            ...
            <div className='py-6 leading-relaxed'>
              <strong className='text-2xl '>Material complemtentar</strong>
